...
\item A vote is won by the poll expiring and the number of yes votes being greater than the number of no votes.
Abstain votes do not directly affect the results, however, poll results are only valid if they receive 5 or more total votes, this includes abstain votes.
\end{itemize}
\end{document}
